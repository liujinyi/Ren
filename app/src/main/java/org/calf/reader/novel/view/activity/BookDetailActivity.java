...
public class BookDetailActivity extends MBaseActivity<BookDetailContract.Presenter> implements BookDetailContract.View {
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        getIntent().putExtra("openFrom", BookDetailPresenter.FROM_BOOKSHELF);
    ...
    private void upChapterSizeTv() {
        String chapterSize = "";
        if (mPresenter.getOpenFrom() == BookDetailPresenter.FROM_BOOKSHELF && bookShelfBean.getChapterListSize() > 0) {
