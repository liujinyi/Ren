...
public class LauncherIcon {
    ...
    private static ComponentName componentNameMain = new ComponentName(MApplication.getInstance(), "org.calf.reader.novel.view.activity.WelcomeActivity");
    private static ComponentName componentNameBookMain = new ComponentName(MApplication.getInstance(), "org.calf.reader.novel.view.activity.WelcomeBookActivity");
