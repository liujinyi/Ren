...
import org.calf.reader.novel.bean.BookKindBean;
...
import org.calf.reader.novel.view.adapter.base.BaseListAdapter;
import org.calf.reader.novel.widget.CoverImageView;
import org.calf.reader.novel.widget.recycler.refresh.RefreshRecyclerViewAdapter;
...
public class SearchBookAdapter extends RefreshRecyclerViewAdapter {
    ...
    public void onBindIViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        //来源
        if (StringUtils.isTrimEmpty(searchBooks.get(position).getOrigin())) {
        ...
        //最新章节
        if (StringUtils.isTrimEmpty(searchBooks.get(position).getLastChapter())) {
        ...
        //简介
        if (StringUtils.isTrimEmpty(searchBooks.get(position).getIntroduce())) {
