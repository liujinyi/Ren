...
public class ReadBookControl {
    ...
    void updateReaderSettings() {
        ...
        this.paddingLeft = preferences.getInt("paddingLeft", PageLoader.DEFAULT_MARGIN_WIDTH);
        this.paddingTop = preferences.getInt("paddingTop", 0);
        this.paddingRight = preferences.getInt("paddingRight", PageLoader.DEFAULT_MARGIN_WIDTH);
        this.paddingBottom = preferences.getInt("paddingBottom", 0);
        this.tipPaddingLeft = preferences.getInt("tipPaddingLeft", PageLoader.DEFAULT_MARGIN_WIDTH);
        this.tipPaddingTop = preferences.getInt("tipPaddingTop", 0);
        this.tipPaddingRight = preferences.getInt("tipPaddingRight", PageLoader.DEFAULT_MARGIN_WIDTH);
