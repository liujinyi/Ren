package org.calf.reader.novel.web.controller;
...
import org.calf.reader.novel.model.content.Debug;
...
public class SourceDebugWebSocket extends NanoWSD.WebSocket {
    ...
    protected void onMessage(NanoWSD.WebSocketFrame message) {
        ...
        Map<String, String> debugBean = new Gson().fromJson(message.getTextPayload(), AppConstant.MAP_STRING);
